...
ArduinoのPMWインターフェースを制御するHardware Abstraction Layer

## 動作確認済みデバイス
以下のGrove用LEDの明るさを変更することで動作を確認しています．

- [Grove LED 赤 Arduino用][GroveLED]
...
[GroveLED]:https://jp.seeedstudio.com/Grove-Red-LED.html
